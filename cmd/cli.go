...
func init() {
	...
	cliCmd.Flags().StringVarP(&productId, "id", "i", "", "Get Product ID")
	cliCmd.Flags().StringVarP(&productName, "product", "n", "", "Get Product Name")
	cliCmd.Flags().Float64VarP(&productPrice, "price", "p", 0, "Get Product Price")
