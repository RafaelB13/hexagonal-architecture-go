...
import (
	...
	dbInfra "github.com/rafaelb13/full-cycle-hexagonal/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.full-cycle-hexagonal.yaml)")
