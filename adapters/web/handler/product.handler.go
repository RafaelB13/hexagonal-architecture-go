...
import (
	...
	"github.com/rafaelb13/full-cycle-hexagonal/adapters/dto"
	"github.com/rafaelb13/full-cycle-hexagonal/adapters/web/utils"
...
func createProduct(service application.ProductServiceInterface) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			...
			w.Write(utils.ErrorJson("Invalid product"))
			return
		}
		...
		if err != nil {
			...
			w.Write(utils.ErrorJson(err.Error()))
			return
		}
